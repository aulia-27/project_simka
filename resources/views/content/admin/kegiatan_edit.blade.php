...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ url('/kegiatan_update/' . $data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="text" name="tgl_kegiatan" class="form-control" placeholder="tahun(1900)-bulan(01)-hari(01)" value="{{ $data->tgl_kegiatan }}">
                    </div>
                    ...
                    <div class="form-group mt-1">
                        ...
                        <textarea name="deskripsi" class="form-control" style="height: 150px" placeholder="Masukan Text">{{ $data->deskripsi }}"</textarea>
                    </div>
