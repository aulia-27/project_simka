            ...
            <div class="card-body">
                <form action="{{ url('/update/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Masukan Text" value="{{ $data->name }}">
                    </div>

                    <div class="form-group mt-1">
                        <label for="nama"  class="mt-1">Email</label>
                        <input type="text" name="email" class="form-control" placeholder="example@gmail.com" value="{{ $data->email }}">
                    </div>

                    <div class="form-group mt-1">
                        <label for="nama" class="mt-1">Password</label>
                        <input type="text" name="password" class="form-control" placeholder="Masukan Text" value="{{ $data->password }}">
                    </div>
